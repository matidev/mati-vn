...
jQuery(function ($) {
    ...
    if ($toolsBlock.length) {
        ...
        $toolsInput.val(generateString(32)).focus();
        setTimeout(function () {
            ...
            if (typeof value !== 'undefined' && value !== '') {
                ...
                if (typeof CryptoJS !== 'undefined') {
                    ...
                    if (typeof CryptoJS.SHA1(value) !== 'undefined') {
                        $toolsResult.append(toolResultTpl('SHA-1', CryptoJS.SHA1(value), true));
                    }

                    if (typeof CryptoJS.SHA256(value) !== 'undefined') {
                        $toolsResult.append(toolResultTpl('SHA-256 (SHA-2)', CryptoJS.SHA256(value), true));
                    }

                    if (typeof CryptoJS.SHA512(value) !== 'undefined') {
                        $toolsResult.append(toolResultTpl('SHA-512 (SHA-2)', CryptoJS.SHA512(value), true));
                    }

                    if (typeof CryptoJS.SHA3(value) !== 'undefined') {
                        $toolsResult.append(toolResultTpl('SHA-3', CryptoJS.SHA3(value), true));
                    }
                }
